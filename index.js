window.onload = function () {
  ...
  var data = {
    ...
    about: {
      ...
      text: "<b>heyatqutusu.az nədir?</b> <br>Ana səhifəsi 10 000 qutudan (xanadan) ibarət olan xeyriyyə yönümlü saytdır. Saytın əsas məqsədi talassemiyadan əziyyət çəkən 6 yaşlı Tunarın ilik nəqli əməliyyatı üçün 100 000 AZN toplamaqdır. Buna görə hər bir xananın qiyməti 10 AZN təşkil edir.<br><br> <b>xeyirxahlıq bilbordu</b><br> 10 000 qutunu böyük bir bilbord kimi düşünün. Siz yardım məqsədilə ailənin hesabına (saytın yox, məhz ailənin) köçürmə edirsiniz. Bu köçürmənin məbləğinə uyğun olaraq bu digital bilbordda sizə öz şirkətiniz və ya işlədiyiniz şirkətin, məhsulunuzun, bloqunuzun və ya şəxsi səhifənizin kiçik emblemini və bu emblem üzərindən keçid yerləşdirirsiniz. Bu emblem və keçid saytda bir il aktiv qalır. Beləcə, həm bir körpəyə dəstək göstərirsiniz, həm də bu maraqlı saytı ziyarət edənlər sizdən, məhsulunuzdan və ya bloqunuzdan xəbərdar olur. <br><br> <b>arzumuz var...</b><br> Arzumuz bu bilbordun tezliklə dolması və ortaya çıxacaq o qarışıq, rəngarəng tablonun Tunarı sağlamlığına qovuşdurmasıdır. Yardım edərək Siz də bu tablonun bir parçası olun. Ümid edirik ki, Tunarla başlayan bu layihə davamlı olar, həyat qutuları daha neçə-neçə körpəyə həyat bəxş edər.",
    },
    contact: {
      banner: './images/contact.jpg',
