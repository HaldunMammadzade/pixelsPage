window.onload = function () {
  ...
  var data = {
    ...
    contact: {
      banner: './images/contact.jpg',
    text: "<b>qutular necə alınır?</b> <br> 1️⃣ Soldakı şəkildə qeyd olunmuş hesaba köçürmə edin<br> 2️⃣ Bu köçürmənin qəbzini instaqram səhifəmizə, yaxud heyatqutusu@gmail.com imeylinə və ya +994 51 345 25 17 votsap nömrəmizə göndərin. <br> Qəbz göndərildikdən sonra köçürülən məbləğ müqabilində sizin üçün xana(lar) ayrılır. Siz bu xana(lar)da olmasını istədiyiniz emblemi və bu vizuala kliklədikdə keçid olunacaq linki qeyd edirsiniz. <br>Sözügedən hesab körpənin ailəsinə məxsusdur, heyatqutusu.az sadəcə vasitəçidir.<br><br> <b>nümunə</b> <br>Yardım hesabına 250 AZN ödəmisiniz. Bu o deməkdir ki, siz artıq 25 qutu (xana) sahibisiniz. Səhifədən sizə 5x5 ölçülü sahə ayrılır. Bu sahəyə sizin emblem, həmçinin  link yerləşdirilir və onlar 2022-ci ilin dekabrınadək aktiv qalır. Beləcə, siz həm layihəyə dəstək olursunuz, həm də bu maraqlı saytı ziyarət edənlər şirkətinizdən, məhsulunuzdan və ya bloqunuzdan xəbərdar olur.<br><br><b>kimlər qutu ala bilər?</b><br> Öz şirkətini və ya həmkarları ilə birlikdə dəstək olaraq öz işlədikləri şirkətini, brendini, sosial media səhifəsini, bloqunu, şəxsi hesabını, bir sözlə hər kəs.",
    },
