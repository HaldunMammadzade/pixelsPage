window.onload = function () {
  ...
  var data = {
    ...
    about: {
      ...
      text: "<b>heyatqutusu.az nədir?</b> <br>Ana səhifəsi 10 000 qutudan (xanadan) ibarət olan xeyriyyə yönümlü saytdır. Saytın əsas məqsədi talassemiyadan əziyyət çəkən 6 yaşlı Tunarın ilik nəqli əməliyyatı üçün 100 000 AZN toplamaqdır. Buna görə hər bir xananın qiyməti 10 AZN təşkil edir.<br><br> <b>Xeyirxahlıq bilbordu</b> 10 000 qutunu böyük bir bilbord kimi düşünün. Siz yardım məqsədilə ailənin hesabına (saytın yox, məhz ailənin) köçürmə edirsiniz. Bu köçürmənin məbləğinə uyğun olaraq bu digital bilbordda sizə öz şirkətiniz və ya işlədiyiniz şirkətin, məhsulunuzun, bloqunuzun və ya şəxsi səhifənizin kiçik emblemini və bu emblem üzərindən keçid yerləşdirirsiniz. Daha ətraflı <Qutu al> səhifəsində! <br><br> <b>Arzumuz var...</b> Arzumuz bu bilbordun tezliklə dolması və ortaya çıxan o qarışıq, rəngarəng görüntünün Tunarı sağlamlığına qovuşdurmasıdır. Hətta Tunarla başlayan bu layihə davamlı olar, başqa körpələrə də həyat işığı doğar. Birlikdən həyat doğar!",
    },
    contact: {
      banner: './images/contact.jpg',
